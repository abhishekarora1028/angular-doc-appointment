        ...
        var app = angular.module('main', ['daypilot']).controller('DemoCtrl', function ($scope, $timeout, $http) {
            ...
            $scope.schedulerConfig = {
                ...
                onEventDeleted: function (args) {
                    ...
                    $http.post("<?php echo site_url('appointments/delete'); ?>", params).success(function () {
                ...
                onTimeRangeSelected: function (args) {
                    ...
                    $http.post("<?php echo site_url('managers/createslots'); ?>", params).success(function (data) {
                        loadEvents();
            ...
            $scope.clear = function () {
                ...
                $http.post("<?php echo site_url('appointments/clear'); ?>", params).success(function (data) {
                    dp.message(data.message);
                    loadEvents();
                });
            };
            ...
            function loadEvents(day) {
                ...
                $http.post("<?php echo site_url('appointments/getall'); ?>", params).success(function (data) {
            ...
            function loadResources() {
                $http.post("<?php echo site_url('doctors/getall'); ?>").success(function (data) {
